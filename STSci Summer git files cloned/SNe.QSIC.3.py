...
region_list = [[6560, 6566],[6675, 6681],[7062, 7068],[7152,7158]]
...
exp_data_ew = Table([date_list, ew1, ew2, ew3, ew4], names=['date', 'Ha ew', 'HeI2 ew', 'HeI3 ew', 'FeII2 ew'])
ascii.write(exp_data_ew, sne_name +'.3.ew.txt', overwrite=True)

exp_data_cont = Table([date_list, cont1, cont2, cont3, cont4], names=['date', 'Ha cont', 'HeI2 cont', 'HeI3 cont', 'FeII2 cont'])
ascii.write(exp_data_cont, sne_name +'.3.cont.txt', overwrite=True)
